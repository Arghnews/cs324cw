...
set shortmess=aoO
badd +62 collision.cpp
badd +1 arm.cpp
badd +11 vertex.shader
badd +1 fragment.shader
badd +1 robot-arm.cpp
badd +0 collision.hpp
args collision.cpp
edit arm.cpp
...
silent! normal! zE
let s:l = 134 - ((28 * winheight(0) + 34) / 68)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((51 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
