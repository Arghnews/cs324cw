...
silent! normal! zE
let s:l = 93 - ((33 * winheight(0) + 34) / 68)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 640 - ((31 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
640
normal! 065|
tabedit Movement.hpp
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 13 - ((3 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
13
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 80 - ((30 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
80
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((19 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((28 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
